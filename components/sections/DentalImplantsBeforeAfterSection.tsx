...
const galleryImages = [
  { src: "/cl-bfaf-1.png", alt: "Dental implants smile transformation showcase" },
  { src: "/cl-bfafs-2.png", alt: "Dental implants restored bite result" },
  { src: "/cl-bfaf-3.png", alt: "Dental implants smile restoration visual" },
];
