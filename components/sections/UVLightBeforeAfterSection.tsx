...
const galleryImages = [
  { src: "/prpbfaf.png", alt: "UV light therapy result showcase" },
  { src: "/prpbfaf1.png", alt: "UV light therapy scalp and hair improvement" },
  { src: "/prpbfaf2.png", alt: "UV light therapy hair outcome visual" },
];
